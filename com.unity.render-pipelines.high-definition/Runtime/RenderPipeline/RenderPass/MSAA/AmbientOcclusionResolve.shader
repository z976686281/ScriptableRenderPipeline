Shader "Hidden/HDRP/AOResolve"
{
    HLSLINCLUDE
        ...
        TEXTURE2DX(_DepthValuesTexture);
        TEXTURE2DX(_MultiAmbientOcclusionTexture);
        ...
        float Frag(Varyings input) : SV_Target
        {
            ...
            float4 depthValues = LOAD_TEXTURE2DX(_DepthValuesTexture, pixelCoords);
            ...
            // Fetch the AO values
            float2 aoValues = LOAD_TEXTURE2DX(_MultiAmbientOcclusionTexture, pixelCoords).xy;
