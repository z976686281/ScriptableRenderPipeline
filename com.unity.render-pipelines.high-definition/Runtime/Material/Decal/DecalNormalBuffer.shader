Shader "Hidden/HDRP/Material/Decal/DecalNormalBuffer"
{
    ...
    HLSLINCLUDE
        ...
        RW_TEXTURE2DX(unorm float4, _NormalBuffer) : register(u1);
#else
        RW_TEXTURE2DX(float4, _NormalBuffer);
#endif
        ...
        void FragNearest(Varyings input)
        {
            ...
            float4 GBufferNormal = _NormalBuffer[COORD_TEXTURE2DX(positionSS)];
            ...
            _NormalBuffer[COORD_TEXTURE2DX(positionSS)] = GBufferNormal;
        }
