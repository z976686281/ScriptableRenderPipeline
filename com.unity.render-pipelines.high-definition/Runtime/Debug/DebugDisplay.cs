...
namespace UnityEngine.Experimental.Rendering.HDPipeline
{
    ...
    public class DebugDisplaySettings : IDebugData
    {
        ...
        void RegisterDisplayStatsDebug()
        {
            ...
            if (data.countRays)
            {
                list.Add(new DebugUI.Value { displayName = "Ray rate (MRays/s)", getter = () => ((float)(RenderPipelineManager.currentPipeline as HDRenderPipeline).GetRaysPerFrame()) / 1e6f, refreshRate = 1f / 30f });
